...
DATABASES = {
    'default': {
        ...
        'NAME': 'resultworks',                      # Or path to database file if using sqlite3.
...
SECRET_KEY = '-sf4^1*-2i56k&amp;9=fb2&amp;c%o*f1wukbdsero$nh^c*vz761ff9r'
...
ROOT_URLCONF = 'resulworks.urls'

# Python dotted path to the WSGI application used by Django's runserver.
WSGI_APPLICATION = 'resulworks.wsgi.application'
